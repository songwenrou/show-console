...
var Slog = function () {
    function Slog() {
        ...
        (0, _classCallCheck3.default)(this, Slog);

        this.slogInit = function () {
            ...
            var mainHtml = document.querySelector('#slog');
            var msglistDom = document.querySelector('#slog-list');
            var domBody = '\n        <button class="slog-button" id="slog-btn">\u8C03\u8BD5</button>\n        <div class="slog-bg box-hide" id="slog-bg">\n            <div class="slog-list-box" id="slog-box">\n                <div class="slog-list-title">\n                    <div class="slog-list-title-item" onClick="showAll">all</div>\n                    <div class="slog-list-title-item" onClick="showLog">log</div>\n                    <div class="slog-list-title-item" onClick="error">error</div>\n                </div>\n                <div class="slog-list" id="slog-list">\n                </div>\n            </div>\n        </div>\n        \n  ';
...
exports.default = consoleFun;

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function consoleFun() {
    if (console) {
        var addList = function addList(arg) {
            ...
            if (mainHtml) {
                ...
                unsentList.forEach(function (item) {
                    addDom(item);
                });
                unsentList = [];
            }

            allList.push((0, _stringify2.default)(arg));
            consoleList.push((0, _stringify2.default)(arg));
        };

        var addDom = function addDom(item) {
            var node = document.createElement("DIV");
            // _console.log(item)
            node.className = "slog-list-item";
            node.innerHTML = (0, _values2.default)(item).reduce(function (domStr, i) {
                var aa = function aa(i) {
                    if (type(i) == 'Object' || type(i) == 'Array') {

                        return domStr + '' + (0, _entries2.default)(i).reduce(function (itemDomStr, arr, index) {
                            return itemDomStr + '<div class="slog-list-child"><span class="slog-list-red">' + arr[0] + '</span>:' + aa(arr[1]) + '</div>';
                        }, '<span class="slog-list-blue-light"><em> ' + type(i) + ' </em>: ' + (0, _stringify2.default)(i) + '</span>');
                    } else {
        ...
        var type = function type(i) {
            return Object.prototype.toString.call(i).slice(8, -1);
        };

        var addObjectDom = function addObjectDom(e) {
        ...
        var addHtml = function addHtml(arg) {
            // for ( let item in arg){
        ...
        var findFatherDom = function findFatherDom(childDom) {
            // console.log(childDom)
            if (childDom.parentNode.className == 'slog-list-item' || childDom.parentNode.className == 'slog-list-child') {
        ...
        var childrenDomClick = function childrenDomClick(e) {
            var dom = void 0;
        ...
        var mainHtml = document.querySelector('#slog-list');
        var unsentList = [];
        ...
        console.error = function () {
            ...
            _console.log((0, _stringify2.default)((0, _values2.default)(arguments)));
...
var $export = __webpack_require__(2);
var $entries = __webpack_require__(9)(true);
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(2);
var $values = __webpack_require__(9)(false);
